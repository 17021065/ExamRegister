...
<?php
		...
		$roomList = $adminShift->showAllShift();
?>
<!--
Author: W3layouts
...
<!--header end here-->
    <ol class="breadcrumb"> 
                ...
                <li class="breadcrumb-item"><a href="m_exam.php">Quản lí kì thi</a> <i class="fa fa-angle-right"></i></li>
            </ol>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="../controller/c_admin.php" method="POST">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Kì thi</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="semester">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Mã học phần</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="code">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Ngày thi</label>
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="focusedinput" name="date">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Ca thi</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="shift">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Phòng thi</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="room">
									</div>
								</div>
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Số máy</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" name="num">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-8 col-sm-offset-2">
										<button class="btn-primary btn" type="submit" name="add">Thêm</button>
